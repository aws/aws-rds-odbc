...
int main(int argc, char* argv[]) {
    ...
    FederatedAuthType authType = FederatedAuthType::ADFS;
    ...
    std::strcpy(authConfig.iam_role_arn, "arn:aws:iam::123412341234:role/adfs_example_role");
    std::strcpy(authConfig.iam_idp_arn, "arn:aws:iam::123412341234:saml-provider/adfs_example_provider");
    std::strcpy(authConfig.idp_username, "user@email.com");
    std::strcpy(authConfig.idp_password, "email_password");
